...
**Stories:** 2.1, 2.2, 2.3, 2.4 (4 stories)  
**Total Effort:** 100 hours (Dev + QA + Review)
...
**Effort:** 26 hours  
**Dependencies:** 2.1 (editor exists), 3.3 (metering exists for cost tracking)
...
**Story 2.3 (Llama)** depends on **Story 3.3 (Metering)** from Epic 3. This is a cross-epic dependency.
- **Workaround:** 3.3 can start in parallel and complete before 2.3 ships.
- **Alternative:** Implement basic token logging in 2.3 story itself; formalize in 3.3.
