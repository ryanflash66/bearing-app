...
- **Refactoring (2026-01-18)**:
    - Separated interim dictation text from editor content to prevent autosave of unstable text.
    - Added "Ghost Text" overlay for interim results using a sticky header component.
    - Added error handling UI for dictation failures (e.g., permission denied).
    - Improved `useDictation` test coverage for `onresult` events.
