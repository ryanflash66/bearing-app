...
| `prd-epic-2.md` | Editor & Llama AI | Weeks 8-11 | 2.1-2.5 (5) | 120h | $0.10 |
| `prd-epic-3.md` | Consistency Engine | Weeks 11-14 | 3.1-3.2 (2) | 46h | $1.35 |
| `prd-epic-4.md` | Support & Admin | Weeks 14-16 | 4.1-4.3 (3) | 54h | $0 |
| **TOTAL** | — | 18 weeks | 14 stories | **302h** | **$1.45/month** |
...
Week 8-11:  Epic 2 (Manuscript Editor & Llama AI)
  → Weeks 8-9: Stories 2.1, 2.2, 2.5 (Metering starts early)
...
Week 11-14: Epic 3 (Consistency Engine)
  → Weeks 11-13: Stories 3.1, 3.2 in parallel
...
```
1.1 (Auth) → 1.2, 1.3, 1.4 → 2.1 → 2.5 (Metering) → 2.3 (Llama) → 3.1 → 4.1
```
...
- [ ] Metering accurate and enforced
