...
FR-26: (New) Epic 5 - Service Marketplace
FR-27: (New) Epic 5 - ISBN Logic
FR-28: (New) Epic 6 - AI Covers
FR-29: (New) Epic 6 - Blog System
...
Encapsulate all financial and service-based transactions (ISBNs, Editing).
**FRs covered:** FR-26, FR-27

### Epic 6: Creative Tools (AI Covers & Blog)
Empower authors to generate release-ready assets and build their audience.
...
**Given** a specific mode selected (Rewrite, Expand, Shorten)
**When** triggered
**Then** the AI prompt includes the specific instruction ("Rewrite this to be more...", "Expand this scene...", "Shorten this paragraph...")
**And** the output replaces the selection ONLY upon user confirmation (Accept/Reject UI)
...
**Given** a completed consistency report
**When** viewing
**Then** issues are categorized (Plot, Character, Tone, Timeline)
...
**Description**
Admins search and view all user manuscripts (Read-Only).
**Acceptance Criteria**
*   Paginated table of all manuscripts.
*   Search by Title/Author.
*   Click to View (Read Only) with Audit Log trigger.

### Story 4.8: Security & Audit Log Viewer
**Description**
Admins inspect system security logs.
**Acceptance Criteria**
*   Filterable view of `audit_logs`.
...
**Description**
Authors browse a catalog of available services (ISBN, Editing).
**Acceptance Criteria**
*   Grid view of service cards (Title, Price, Time).
*   "Designer" personas see "Task Board" view.
*   Mobile responsive layout.

### Story 5.2: ISBN Purchase Workflow
**Description**
Authors purchase valid ISBNs via Stripe.
**Acceptance Criteria**
*   Stripe checkout initiation.
*   Webhook creates Service Request (Pending).
*   Warns if ISBN pool is empty (Backorder).

### Story 5.3: Service Request Management
**Description**
Authors track the status of purchase services.
**Acceptance Criteria**
*   List view of "My Orders".
*   Status badges (Pending, Processing, Complete).

### Story 5.4: Admin Fulfillment Dashboard
**Description**
Admins fulfill service requests (e.g. assign ISBNs).
**Acceptance Criteria**
*   Table of pending requests.
*   Action "Mark Complete" triggers email.

## Epic 6: Creative Tools (AI Covers & Blog)

### Story 6.1: AI Cover Generator
**Description**
Generate visual cover concepts using AI.
**Acceptance Criteria**
*   Input prompt (Title, Genre, Mood).
*   Async generation (4 variants).
*   Save to manuscript metadata.
*   Safety filters enforced.

### Story 6.2: Blog Management
**Description**
Simple CMS for author posts.
**Acceptance Criteria**
*   CRUD for Blog Posts (Title, Body, Tags).
*   Draft vs Published status.

### Story 6.3: Public Author Profile/Blog View
**Description**
Reader-facing pages for author content.
**Acceptance Criteria**
*   Public route `/@authorname`.
*   Lists published books and blog posts.
*   SSR for SEO.

### Story 6.4: Admin Blog Moderation
**Description**
Admins moderate public content.
**Acceptance Criteria**
*   Report content workflow.
*   Admin "Takedown" action hides post globally.
